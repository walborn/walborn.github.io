...
const resume: Resume = {
  ...
  hello: `
     Я во фронте 8 лет, а может больше. Фанат React и TS. Работал в стартапе, маленькой компании и в большой корпорации. Писал приложения под большую нагрузку и быстрый time to market.
  ...
  experiences: [
    {
      ...
      achivements: [
        'Запустил с нуля два успешных проекта ~~и один неуспешный~~',
  ...
  educations: [
    {
      ...
      value: 'Факультет инноваций и высоких технологи',
    },
    {
  ...
  about: `В программирование пришёл из любви к математике, а во фронтенд из любви к дизайну. Дипломную работу писал по 3D визуализации трассировкой лучей, но в конце аспирантуры бросил всё и ушёл во фронтенд, что стало моим лучшим решением.
  Я интроверт, но умею находить общий язык со всеми. Очень ценю дружный коллектив, где все друг другу доверяют и помогают.
  Нравится заниматься образовательной деятельностью. Пишу статьи на хабре и веду телеграмм канал. Меня вдохновляет, когда получается объяснить сложные вещи просто и когда это приносит кому-то реальную пользу. Хочется верить, что у меня это получается очень хорошо!
  `,
}
