  ...
  languages: [
    {
      ...
      value: (
        <div>
          Upper-Intermediate <div className={styles.code}>B2</div>
        </div>
      ),
    },
  ],
  experiences: [
    {
      ...
      achivements: [
        'Успешный онбоардинг двух новых сотрудников',
        'Деплой трех новых сервисов в продакшен',
        'Разработан гайд по проектированию и разработке фронтенд сервисов',
      ],
      stack: [
        'TS',
        'NextJS',
